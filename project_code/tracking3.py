...
def collided(our_car, c1 = Car(-1, 4, 4.6, 1.5, 0), c2 = Car(4, 4, 4.7, 1.7, 0), plot_only_colliding_flag = False ):
...
def tracking_graph(car1 = Car(2, 4, 4, 2.5, 1.5708) ,  car2 = Car(7, 4, 4, 2.5, 1.5708), filename = './Live_plans/Trajectory_test_plan_virtual_0'):
    x2 = 5
    y2 = 15
    len2 = 4.7
    wid2 = 1.7
...
if __name__ == '__main__':
    #car1 =Car(2, 4, 4, 2.5, np.pi/2); car2 =Car(7, 4, 4, 2.5, np.pi/2) #prep parking
    car1 = Car(-2, 2.5, 4, 2.5, 0)	; car2 = Car(8, 2.5, 4, 2.5, 0)   # Parallel parking
    
    filename = './Live_plans/Trajectory_test_plan_virtual_0'
    #filename = './Live_plans/Trajectory_test_plan_live_map_0'
    #filename = './Good_plans/Trajectory_test_plan_virtual_0_parallel_DEC_18'
    #filename = './Good_plans/Trajectory_DEC_17_parallel_found_0'
    #filename ='./Good_plans/Trajectory_DEC_17_live_map_found_0'
    #filename = './Good_plans/Trajectory_DEC_15_perpendicular_decent'

    tracking_graph(car1, car2, filename)
